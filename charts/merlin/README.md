...
| merlinExternalPostgresql.enableProxySidecar | bool | `true` | Enable if you want to configure a sidecar for creating a proxy for your db connections. |
...
| merlinExternalPostgresql.sidecarSpec | object | `{"cloudSqlProxy":{"dbConnectionName":"asia-east-1:merlin-db","dbPort":5432,"serviceAccountCreds":"/etc/gcp_service_account/service-account.json","spec":[{"command":["/cloud_sql_proxy","-ip_address_types=PRIVATE","-log_debug_stdout","-instances={{ .Values.merlinExternalPostgresql.sidecarSpec.cloudSqlProxy.dbConnectionName }}=tcp:{{ .Values.merlinExternalPostgresql.sidecarSpec.cloudSqlProxy.dbPort }}","-credential_file={{ .Values.merlinExternalPostgresql.sidecarSpec.cloudSqlProxy.serviceAccountCreds }}"],"image":"gcr.io/cloudsql-docker/gce-proxy:1.33.2","name":"cloud-sql-proxy","resources":{"limits":{"cpu":"1000m","memory":"1G"},"requests":{"cpu":"200m","memory":"512Mi"}},"securityContext":{"runAsNonRoot":true}}]}}` | container spec for the sidecar |
...
| merlinExternalPostgresql.sidecarSpec.cloudSqlProxy.serviceAccountCreds | string | `"/etc/gcp_service_account/service-account.json"` | When not using Googles workload identity, Give the path to the service account file which has the required permissions. |
| merlinExternalPostgresql.sidecarSpec.cloudSqlProxy.spec | list | `[{"command":["/cloud_sql_proxy","-ip_address_types=PRIVATE","-log_debug_stdout","-instances={{ .Values.merlinExternalPostgresql.sidecarSpec.cloudSqlProxy.dbConnectionName }}=tcp:{{ .Values.merlinExternalPostgresql.sidecarSpec.cloudSqlProxy.dbPort }}","-credential_file={{ .Values.merlinExternalPostgresql.sidecarSpec.cloudSqlProxy.serviceAccountCreds }}"],"image":"gcr.io/cloudsql-docker/gce-proxy:1.33.2","name":"cloud-sql-proxy","resources":{"limits":{"cpu":"1000m","memory":"1G"},"requests":{"cpu":"200m","memory":"512Mi"}},"securityContext":{"runAsNonRoot":true}}]` | Container spec for the sidecar |
...
| mlflowExternalPostgresql.sidecarSpec | object | `{"cloudSqlProxy":{"dbConnectionName":"asia-east-1:mlflow-db","dbPort":5432,"serviceAccountCreds":"/etc/gcp_service_account/service-account.json","spec":[{"command":["/cloud_sql_proxy","-ip_address_types=PRIVATE","-log_debug_stdout","-instances={{ .Values.merlinExternalPostgresql.sidecarSpec.cloudSqlProxy.dbConnectionName }}=tcp:{{ .Values.merlinExternalPostgresql.sidecarSpec.cloudSqlProxy.dbPort }}","-credential_file={{ .Values.merlinExternalPostgresql.sidecarSpec.cloudSqlProxy.serviceAccountCreds }}"],"image":"gcr.io/cloudsql-docker/gce-proxy:1.33.2","name":"cloud-sql-proxy","resources":{"limits":{"cpu":"1000m","memory":"1G"},"requests":{"cpu":"200m","memory":"512Mi"}},"securityContext":{"runAsNonRoot":true}}]}}` | container spec for the sidecar |
| mlflowExternalPostgresql.sidecarSpec.cloudSqlProxy | object | `{"dbConnectionName":"asia-east-1:mlflow-db","dbPort":5432,"serviceAccountCreds":"/etc/gcp_service_account/service-account.json","spec":[{"command":["/cloud_sql_proxy","-ip_address_types=PRIVATE","-log_debug_stdout","-instances={{ .Values.merlinExternalPostgresql.sidecarSpec.cloudSqlProxy.dbConnectionName }}=tcp:{{ .Values.merlinExternalPostgresql.sidecarSpec.cloudSqlProxy.dbPort }}","-credential_file={{ .Values.merlinExternalPostgresql.sidecarSpec.cloudSqlProxy.serviceAccountCreds }}"],"image":"gcr.io/cloudsql-docker/gce-proxy:1.33.2","name":"cloud-sql-proxy","resources":{"limits":{"cpu":"1000m","memory":"1G"},"requests":{"cpu":"200m","memory":"512Mi"}},"securityContext":{"runAsNonRoot":true}}]}` | container spec for the Google CloudSQL auth proxy sidecar, ref: https://cloud.google.com/sql/docs/postgres/connect-kubernetes-engine |
| mlflowExternalPostgresql.sidecarSpec.cloudSqlProxy.serviceAccountCreds | string | `"/etc/gcp_service_account/service-account.json"` | When not using Googles workload identity, Give the path to the service account file which has the required permissions. |
