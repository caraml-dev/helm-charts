...
![Version: 0.4.20](https://img.shields.io/badge/Version-0.4.20-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.0.0](https://img.shields.io/badge/AppVersion-1.0.0-informational?style=flat-square)
...
|------------|------|---------|
| file://../caraml-authz | caraml-authz(authz) | 0.1.6 |
...
| https://caraml-dev.github.io/helm-charts | merlin | 0.9.33 |
